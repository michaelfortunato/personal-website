...
export default function About2(props) {
	...
	return (
		<StyledPage ref={pageRef}>
			...
			<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" height="100%" width="100%" viewBox={`0 0 ${VIEWBOX_WIDTH} ${VIEWBOX_HEIGHT}`} preserveAspectRatio="none">
				<defs>
				</defs>
				...
				<g id="_1" data-name="1">
					...
					<g>
						<polyline class="cls-3" points={`1074.98 181.12 804.5 183.65 648.5 295.65 ${percentToSVGX(ContentBoxes[0].x, contentBoxRefs[0])} ${percentToSVGY(ContentBoxes[0].y, contentBoxRefs[0])}`} transform="scale(1,1)"/>
						<path class="cls-4" d="M904,291.5c31.35-11.29,70.29-30.7,94.52-51.41L979.1,292.22l18.42,52.48C973.69,323.53,935.13,303.38,904,291.5Z" transform={`translate(${percentToSVGX(ContentBoxes[0].x, contentBoxRefs[0]) - 904} ${percentToSVGY(ContentBoxes[0].y, contentBoxRefs[0]) - 291.5}  )`} />
					</g>
				</g>
				<g id="_2" data-name="2">
				...
				<g id="_3" data-name="3">
					...
					<g>
						...
						<polyline class="cls-3" points="1074.32 557.37 118 557" />
