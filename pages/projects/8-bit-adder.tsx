...
export default function Page() {
  return (
    <Layout url="/projects/8-bit-adder">
      <div className="prose mt-4 flex flex-col items-center gap-2">
        <h2>Overview</h2>
        <p>
          TODO: I need to sit down this weekend and write about this project in
          full. Also I need to actually make a nice page of this.
        </p>
        <p>
        ...
        <p>
          Disclaimer: I do not think my design is energy efficient nor represent
          a best practice. I hope to take an EE class in graduate school if I
          get in.
        </p>
        <Link
